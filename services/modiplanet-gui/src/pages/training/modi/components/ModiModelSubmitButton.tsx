...
import { useDataModel, useMyModelModiClassifier } from '@src/store/zustand';
...
interface ModiModelSubmitButton {}

function ModiModelSubmitButton({}: ModiModelSubmitButton) {
  const { model } = useDataModel();
  const { modelUrl, classifiers, modelName, modiType, modelId, isCreationModel } =
...
export default ModiModelSubmitButton;
