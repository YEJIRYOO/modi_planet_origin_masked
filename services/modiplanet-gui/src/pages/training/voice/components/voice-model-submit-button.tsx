...
import { useVoiceModel, useMyModelVoiceClassifier } from '@src/store/zustand';
...
interface VoiceModelSubmitButton {}

function VoiceModelSubmitButton({}: VoiceModelSubmitButton) {
...
export default VoiceModelSubmitButton;
