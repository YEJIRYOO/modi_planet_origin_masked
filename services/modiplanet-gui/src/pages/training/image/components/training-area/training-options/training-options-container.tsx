import TrainingParamsSetting from '@src/pages/training/image/components/training-area/training-options/training-params-setting';
import TrainingLogGraph from '@src/pages/training/image/components/training-area/training-options/training-log-graph';
import { useState } from 'react';
import {
  TMyModelParams,
  useMyModelImageClassifier,
} from '@src/store/zustand/ai/my-model-image-classifier';
...
function TrainingOptionsContainer({
  ...
  const { modelParams, updateModelParams } = useMyModelImageClassifier(
    (state) => ({
